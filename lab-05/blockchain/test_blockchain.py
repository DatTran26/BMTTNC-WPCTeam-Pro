...
new_block = my_blockchain.create_block(
    proof=new_proof, previous_hash=previous_hash
)
...
print(
    f"Is the blockchain valid: {my_blockchain.is_chain_valid(my_blockchain.chain)}"
)
